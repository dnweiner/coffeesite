...
coffeesControllers.controller('CoffeesCtrl', function($scope) {
    $scope.coffees = coffees; 
	$scope.orderProp = 'name';
});

coffeesControllers.controller('ReviewsCtrl', function($scope, $routeParams) {
	console.log("Id to review is:" + $routeParams.coffeeId);
	$scope.coffeeReviews = coffees[$routeParams.coffeeId-1];
});